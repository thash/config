...
liberator.globalVariables.copy_templates = [
  ...
  { label: 'anchorWithHateB', value: '<a href="%URL%">%TITLE%</a> <a href="http://b.hatena.ne.jp/entry/%URL%"> <img src="http://b.hatena.ne.jp/entry/image/%URL%" title="%TITLE%" border="0"></a>' },
...
if (!liberator.globalVariables.copy_templates){
    liberator.globalVariables.copy_templates = [
        { label: 'titleAndURL',    value: '%TITLE%\n%URL%' },
  { label: 'HateB', value: '<a href="%URL%">%TITLE%</a> <a href="http://b.hatena.ne.jp/entry/%URL%"> <img src="http://b.hatena.ne.jp/entry/image/%URL%" title="%TITLE%" border="0"></a>' },
        { label: 'anchor',         value: '<a href="%URL%">%TITLE%</a>' },
        { label: 'selanchor',      value: '<a href="%URL%" title="%TITLE%">%SEL%</a>' },
        { label: 'Quote', value: '<blockquote cite="%URL%" title="%TITLE%">\n%HTMLSEL%\n</blockquote>' }
    ];
}
